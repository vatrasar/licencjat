...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actor_learning_rate_spin.setDecimals(6)
        ...
        self.critic_learning_rate_spin.setDecimals(6)
        ...
        self.etropy_spin = QtWidgets.QDoubleSpinBox(self.centralwidget)
        self.etropy_spin.setDecimals(6)
        self.etropy_spin.setObjectName("etropy_spin")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.etropy_spin)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Współczynnik entropii"))
